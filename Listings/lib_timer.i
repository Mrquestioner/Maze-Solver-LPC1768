...
# 10 "Source/timer/lib_timer.c" 2
# 20 "Source/timer/lib_timer.c"
...
uint32_t init_timer ( uint8_t timer_num)
{
  if ( timer_num == 0 )
  {
# 109 "Source/timer/lib_timer.c"
 ((LPC_TIM_TypeDef *) ((0x40000000UL) + 0x04000) )->MCR = 0;
 ...
 ((LPC_TIM_TypeDef *) ((0x40000000UL) + 0x08000) )->MCR = 2;
